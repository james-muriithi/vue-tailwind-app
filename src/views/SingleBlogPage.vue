  ...
  <div class="pb-7">
    ...
    <div class="container mx-auto mt-7">
      <div class="grid grid-cols-1 gap-3 md:grid-cols-12">
        <div class="md:col-span-2 order-3 md:order-1 mt-5 md:mt-0">
          <quick-links />
        </div>
        <div class="md:col-span-8 order-1 md:order-2 mt-5 md:mt-0">
          <single-blog />
        </div>
        <div class="md:col-span-2 order-2 md:order-3 mt-5 md:mt-0">
          <book-visit />
        </div>
      </div>
    </div>
...
export default {
  name: "SingleBlogPage",
  components: { QuickLinks, BookVisit, SingleBlog },
  data() {
    return {
      breadcrumbMenu: [
        {
